...
function generoiKaikkiVaraosatNakyma() {
    ...
    let html = `
        <h2 style='color: #2c3e50; margin-top: 0;'>Kaikki järjestelmän varaosat ⚙️ <span style="font-size: 18px; color: #7f8c8d; font-weight: normal;">(${osatArray.length} erilaista)</span></h2>
        <div style="background: #f8f9f9; padding: 15px; border-radius: 6px; margin-bottom: 20px; border: 1px solid #bdc3c7; display: flex; gap: 15px; align-items: center;">
            ...
            <input type="text" id="hakuMasterVaraosat" placeholder="🔍 Hae numerolla, nimellä tai hyllypaikalla..." 
                   value="${keskitettyVaraosaHaku}" oninput="keskitettyVaraosaHaku = this.value; generoiKaikkiVaraosatNakyma()" 
